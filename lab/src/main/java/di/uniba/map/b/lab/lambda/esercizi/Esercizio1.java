...
public class Esercizio1 {
    ...
    public static void main(String[] args) {
        try {
            ...
            //raggruppo movie per genre
            Map<String, Set<String>> movieByGenre = movielens.getMovies().stream()
                    .collect(MovieByGenre::new, MovieByGenre::accept, MovieByGenre::combine).getMap();
            //raggruppo ratings per movieId
            Map<String, List<Double>> ratingByMovie = movielens.getRatings().stream()
                    .collect(Collectors
                            .groupingBy(Rating::getMovieId, Collectors
                                    .mapping(r -> new Double(r.getRating()), Collectors.toList())));
            //???
